  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        ...
        <a class="navbar-brand brand-logo-mini" href="gdChinhNVQL.jsp">Thu</a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="gdChinhNVQL.jsp">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="hdk2">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/hopdong/gdTimDoitac.jsp"> Tạo hợp đồng </a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/hopdong/daHopDong.jsp"> Xem danh sách </a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="bctk">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/Error/error.html"> Thống kê đối tác </a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/Error/error.html"> Thống kê khách hàng </a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/Error/error.html"> Thống kê dòng xe </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Cửa hàng thuê xe ô tô</h4>
                </div>
              </div>
            </div>
          </div>
