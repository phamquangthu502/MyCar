											      ...
											      <%
												   ...
												   %>
											        <tr>
											          ...
											          <td> <input type="text" name="number" class="fr price" style=" border: 1px solid #d1cdcd;" disabled/></td>
	 ...
	 $(document).ready( function () {
        ...
        $('input[type="checkbox"]').click(function(){
        	$(".tbody1").find('input[name="record"]').each(function(){
            	if($(this).is(":checked")){
            		$($($(this).parents("tr")[0].cells[7])[0].children).prop('disabled', false);
            		$($($(this).parents("tr")[0].cells[8])[0].children).prop('disabled', false);
                }
            	if($(this).is(":not(:checked)")){
            		$($($(this).parents("tr")[0].cells[7])[0].children).prop('disabled', true);
